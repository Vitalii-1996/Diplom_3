...
class ResetPasswordPage(BasePage):
    ...
    @allure.step('check reset password label is displayed')
    ...
    @allure.step('check reset password button is displayed')
    ...
    @allure.step('click show password')
    ...
    @allure.step('check password input field is active')
